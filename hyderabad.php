<?php
 include("includes/db.php");
    ...
    if (isset($_POST['submit_button'])){
		...
		$sub = $_POST['subject'];
        $msg = $_POST['message'];
        $query = "INSERT INTO `hyderabad_messages` (firstname,lastname,email,subject_message,message) VALUES ('$firstname', '$lastname', '$email','$sub', '$msg')";
...
<html>
	...
	<div id="fh5co-contact">
		<div class="container">
			<div class="row">
				<div class=" col-md-12 heading-state">
					<h1 style="font-size:3em;color:#c89704;">Hyderabad</h1>
				</div>
			</div>
			<div class="row">
      ...
      <?php if(isset($fmsg)){ ?><div class="alert alert-danger" role="alert"> <?php echo $fmsg; ?> </div><?php } ?>
					<form action="hyderabad.php" method="POST">
